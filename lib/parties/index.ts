...
export const parties: Party[] = [
  ...
  { id: 'snp', name: 'SNP', colour: '#ffffff', textColour: '#1a1a1a', leader: 'John Swinney', description: 'Scottish nationalist party', hasMP: true },
  ...
  { id: 'sinnfein', name: 'Sinn Féin', colour: '#2e2e2e', textColour: '#ffffff', leader: 'Michelle O\'Neill', description: 'Irish republican party', hasMP: true },
  ...
  { id: 'alliance', name: 'Alliance', colour: '#ffffff', textColour: '#1a1a1a', leader: 'Naomi Long', description: 'Cross-community centrist party', hasMP: true },
  { id: 'tuv', name: 'TUV', colour: '#222222', textColour: '#ffffff', leader: 'Jim Allister', description: 'Traditional unionist party', hasMP: true },
  { id: 'uup', name: 'UUP', colour: '#ffffff', textColour: '#ffffff', leader: 'Doug Beattie', description: 'Ulster unionist party', hasMP: true },
  { id: 'restore', name: 'Restore Britain', colour: '#1a1a1a', textColour: '#ffffff', leader: 'Rupert Lowe', description: 'Right-wing populist party', hasMP: true },
  { id: 'others', name: 'Others', colour: '#2e2e2e', textColour: '#ffffff', leader: 'Various', description: 'UKIP, Alba and other parties with published policies', hasMP: false },
];
