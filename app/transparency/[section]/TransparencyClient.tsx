  ...
  return (
    <>
        ...
        {isDonations ? (
          <form method="GET" className="flex gap-2 max-w-md">
            <input
              ...
              className="flex-1 bg-[#222222] border border-[#2e2e2e] text-white text-[13px] rounded-sm px-4 py-3 leading-[1.7] placeholder:text-white focus:outline-none focus:border-[#ffffff] transition-colors"
            />
            <button
              type="submit"
          ...
          <>
            <input
              ...
              className="w-full max-w-md bg-[#222222] border border-[#2e2e2e] text-white text-[13px] rounded-sm px-4 py-3 leading-[1.7] placeholder:text-white focus:outline-none focus:border-[#ffffff] transition-colors"
            />
            {query && (
      ...
      {rows.length === 0 && searchQuery ? (
        ...
        <>
          <ul className="space-y-px bg-[#222222] border border-[#2e2e2e]">
            {paged.map((row, i) => {
