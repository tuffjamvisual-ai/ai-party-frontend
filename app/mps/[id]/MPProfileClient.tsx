...
export default function MPProfileClient({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-px border border-[#405b6b]">
      {/* Sidebar */}
              ...
              return (
                <button
                  ...
                  className={
                    ...
                    (active
                      ? 'text-white bg-[#002633] border-l-[#ffffff] font-semibold'
                      : 'text-white border-l-transparent hover:text-white hover:bg-[#002633]')
                  }
                >
                  {item.label}
                </button>
      ...
      <div className="lg:col-span-3 p-6 sm:p-8">
        {activeSection === 'contact' && (
          <Section title={`Contact ${mp.display_name || mp.name}`}>
            {contact ? (
              <div className="space-y-px border border-[#405b6b]">
        ...
        {activeSection === 'voting' && (
          <Section title="Voting Record">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-px border border-[#405b6b] mb-8">
            ...
            {votes && votes.length > 0 ? (
              <ul className="space-y-px border border-[#405b6b]">
              ...
              <div className="space-y-10">
                {Object.keys(interestsByCategory).map((categoryName) => (
                  <div key={categoryName}>
                    <h3 className="text-[13px] uppercase tracking-[0.25em] mb-4 pb-3 border-b border-[#405b6b] font-semibold" style={{ color: ACCENT }}>
                      {categoryName}
                    </h3>
                    <ul className="space-y-px border border-[#405b6b]">
                          ...
                          {interest.child_interests && interest.child_interests.length > 0 && (
                            <ul className="mt-2 ml-3 space-y-1">
                              {interest.child_interests.map((child: any, idx: number) => (
                                <li
                                  key={idx}
                                  className="text-[15px] text-white bg-[#002633] p-2 border-l-2 leading-[1.7]"
