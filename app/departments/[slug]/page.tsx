  ...
  return (
    <div className="min-h-screen bg-[#002633] text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        {/* Header */}
        <header className="border-b border-[#405b6b] pb-8 mb-8">
              ...
              <div className="flex gap-1.5 flex-shrink-0 mt-2">
                {govukData.socialMedia.map((s, i) => (
                  <a
                    ...
                    className="text-[13px] uppercase tracking-[0.15em] px-2 py-1 bg-[#1c3849] text-white rounded-sm border border-[#405b6b] hover:text-white hover:border-[#ffffff] transition-colors"
                  >
        ...
        {/* Secretary of State */}
        <section className="border-b border-[#405b6b] pb-8 mb-8">
        ...
        {/* Stats + Search */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-[#1c3849] border border-[#405b6b] mb-8">
          {slug === 'treasury' ? (
            <div className="bg-[#1c3849] p-5">
              ...
              <div className="grid grid-cols-3 gap-px bg-[#1c3849] border border-[#405b6b]">
                {[
          ...
          <div ref={searchRef} className="bg-[#1c3849] p-5 relative">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-[#002633] border border-[#405b6b] rounded-sm px-4 py-2.5 text-white text-[13px] placeholder:text-white focus:outline-none focus:border-[#ffffff] transition-colors"
              />
              {zoneSearch && (
                <button
            ...
            {showTopics && (
              <div className="absolute z-50 left-5 right-5 mt-1 bg-[#1c3849] border border-[#405b6b] rounded-sm shadow-xl max-h-64 overflow-y-auto">
                {(zoneSearch ? filteredZones : [...dept.controlZones].sort()).map((zone) => {
                  ...
                  return (
                    <button
                      ...
                      className={
                        'block w-full text-left px-4 py-2.5 text-[13px] border-b border-[#405b6b] last:border-0 transition-colors ' +
                        (activeZone === zone ? 'text-[#ffffff] bg-[#002633]' : 'text-white hover:bg-[#002633] hover:text-white')
                      }
                    >
                      {zone}
        ...
        {activeZone && activeZoneData && (
          <section className="border-b border-[#405b6b] pb-8 mb-8">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#1c3849] border border-[#405b6b]">
        ...
        <section>
          ...
          {(govukData?.foiEmail || govukData?.pressPhone) && (
            <div className="flex flex-wrap gap-6 mt-6 pt-6 border-t border-[#405b6b]">
              {govukData.foiEmail && (
                <a
...
function StaffGroup({ label, people }: { label: string; people: { name: string; role: string; slug: string }[] }) {
  return (
    <div className="mb-8">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-[#1c3849] border border-[#405b6b]">
        {people.map((person, i) => (
          <li key={i} className="bg-[#1c3849] p-3 border-l-2 border-l-transparent hover:border-l-[#ffffff] hover:bg-[#002633] transition-colors">
