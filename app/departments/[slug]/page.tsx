  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
              ...
              <div className="flex gap-1.5 flex-shrink-0 mt-2">
                {govukData.socialMedia.map((s, i) => (
                  <a
                    ...
                    className="text-[13px] uppercase tracking-[0.15em] px-2 py-1 bg-[#222222] text-white rounded-sm border border-[#2e2e2e] hover:text-white hover:border-[#ffffff] transition-colors"
                  >
        ...
        {/* Stats + Search */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-[#222222] border border-[#2e2e2e] mb-8">
          {slug === 'treasury' ? (
            <div className="bg-[#222222] p-5">
              ...
              <div className="grid grid-cols-3 gap-px bg-[#222222] border border-[#2e2e2e]">
                {[
          ...
          <div ref={searchRef} className="bg-[#222222] p-5 relative">
            ...
            {showTopics && (
              <div className="absolute z-50 left-5 right-5 mt-1 bg-[#222222] border border-[#2e2e2e] rounded-sm shadow-xl max-h-64 overflow-y-auto">
        ...
        {activeZone && activeZoneData && (
          <section className="border-b border-[#2e2e2e] pb-8 mb-8">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#222222] border border-[#2e2e2e]">
...
function StaffGroup({ label, people }: { label: string; people: { name: string; role: string; slug: string }[] }) {
  return (
    <div className="mb-8">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-[#222222] border border-[#2e2e2e]">
        {people.map((person, i) => (
