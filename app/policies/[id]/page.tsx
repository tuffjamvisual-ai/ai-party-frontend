  ...
  return (
    <div className="min-h-screen bg-[#002633] text-white">
      ...
      <main className="max-w-3xl mx-auto px-6 pb-20">
        ...
        <div className="border-b border-[#405b6b] pb-8 mt-6 mb-8">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-[10px] uppercase tracking-[0.2em] bg-white text-[#002633] px-2 py-0.5 font-bold">{policy.area}</span>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          <div className="bg-[#1c3849] border border-[#1c3849] p-6">
