    ...
    <>
      <div className="sticky top-20 z-40 bg-[#1a1a1a] px-4 py-3 border-b border-[#2e2e2e]">
        <input
          ...
          className="max-w-xl mx-auto block px-4 py-2 bg-[#222222] text-white rounded-lg border border-[#2e2e2e] focus:border-[#ffffff] focus:outline-none"
        />
      </div>
        ...
        {filteredBills.map((bill: any, index: number) => {
          ...
          return (
            <div
              ...
              className="bg-[#1a1a1a] border border-[#2e2e2e] rounded-lg p-4 active:bg-[#222222]"
            >
