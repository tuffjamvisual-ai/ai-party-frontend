            ...
            >
              ...
              <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                ...
                <button
                  ...
                  disabled={hasVoted}
                  className={`flex-1 py-2 rounded text-sm font-medium ${hasVoted ? userVotes[bill.id] === 'no' ? 'bg-[#C9C9C9] text-white' : 'bg-[#222222] text-white' : 'bg-[#C9C9C9] hover:bg-[#C9C9C9] text-white'}`}
                >
