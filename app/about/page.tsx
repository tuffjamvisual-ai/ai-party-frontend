  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12 text-white leading-loose space-y-6">
        <div className="text-xs uppercase tracking-[0.25em] text-[#9a9a9a]">About</div>
        ...
        <div className="pt-6 flex flex-wrap gap-3">
          ...
          <Link href="/how-it-works" className="inline-block px-6 py-3 bg-transparent border border-[#555] text-white font-bold text-sm uppercase tracking-wider hover:border-white transition-colors">
            How it works
          </Link>
        </div>
      </main>
